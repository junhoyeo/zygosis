 ...
 */
export interface ZygosisQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: ZygosisParams;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/zygosis/zygosis/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ZygosisQueryParamsResponse, RpcStatus>({
      path: `/zygosis/zygosis/params`,
      method: "GET",
      format: "json",
      ...params,
    });
