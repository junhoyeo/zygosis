...
import ZygosisZygosisNameservice from './zygosis/zygosis.nameservice'
import ZygosisZygosisZygosis from './zygosis/zygosis.zygosis'
...
export default { 
  ...
  ZygosisZygosisNameservice: load(ZygosisZygosisNameservice, 'zygosis.nameservice'),
  ZygosisZygosisZygosis: load(ZygosisZygosisZygosis, 'zygosis.zygosis'),
