...
import (
	...
	nameservicemodule "zygosis/x/nameservice"
	nameservicemodulekeeper "zygosis/x/nameservice/keeper"
	nameservicemoduletypes "zygosis/x/nameservice/types"
	zygosismodule "zygosis/x/zygosis"
	zygosismodulekeeper "zygosis/x/zygosis/keeper"
	zygosismoduletypes "zygosis/x/zygosis/types"
...
type App struct {
	*baseapp.BaseApp
	...
	ZygosisKeeper zygosismodulekeeper.Keeper
...
func New(
	...
	app.ZygosisKeeper = *zygosismodulekeeper.NewKeeper(
		appCodec,
		keys[zygosismoduletypes.StoreKey],
		keys[zygosismoduletypes.MemStoreKey],
		app.GetSubspace(zygosismoduletypes.ModuleName),
	)
	zygosisModule := zygosismodule.NewAppModule(appCodec, app.ZygosisKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(zygosismoduletypes.ModuleName)
